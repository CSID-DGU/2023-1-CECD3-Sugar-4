...
class UI_1App(QMainWindow):
    def __init__(self):
        ...
        self.show_file_dictionary(os.path.join(os.getcwd(),'app', 'gui', 'Results'))
    ...
    def download_files(self):
        ...
        if download_folder:
            ...
            for item_text in selected_items:
                source_path = os.path.join(os.getcwd(), 'app/gui/Results', self.folder_item, item_text)
    ...
    def handle_listview_doubleclick(self, index):
        item = self.ui.listView.model().itemFromIndex(index)
        if item and os.path.isdir(os.path.join(os.getcwd(), 'app/gui/Results', item.text())):
            self.folder_item = item.text()
            self.show_file_list(os.path.join(os.getcwd(), 'app/gui/Results', item.text()))
...
class UI_3App(QMainWindow):
    def __init__(self):
        ...
        directory = os.path.join(os.getcwd(), 'app', 'gui' 'down')
        ...
        if selected_file_name:
            ...
            try:
                ...
                for dir_name in ['SampleRepo', 'Results']:
                    dir_path = os.path.join(os.getcwd(), 'app', 'gui', dir_name)
                ...
                sample_repo_dir = os.path.join(os.getcwd(), 'app', 'gui', 'SampleRepo', file_name)
...
class UI_4App(QMainWindow):
    ...
    def run_labeling_tool(self):
        ...
        image_path = os.path.join(os.getcwd(), 'app', 'gui', 'Results',  aa)
        image_directory_path = os.path.join(os.getcwd(), 'app', 'gui', 'SampleRepo', aa, 'Upload', image_name)
        bbox_path = os.path.join(os.getcwd(), 'app', 'gui', 'Results', aa, basename +'.txt')
...
class UI_6App(QMainWindow):
    ...
    def run_labeling_tool(self):
        ...
        image_path = self.get_selected_file_name()
        bbox_path = os.path.join(os.getcwd(), 'app', 'gui', 'SampleRepo', file_name, file_name + '_privacy_bbox.txt')
...
class UI_8App(QMainWindow):
    ...
    def perform_sample(self):
        ...
        for selected_file in selected_file_list :   
            ...
            script_path = os.path.join(os.getcwd(), "app", "Model", "SampleProcess.py")
